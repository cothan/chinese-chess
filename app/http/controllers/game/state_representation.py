...
class Gamestate(object):
    ...
    def __init__(self, pieces_true, pieces_false, turn, previous_piece, new_piece, eliminated=None):
        ...
        # Contains a gamegrid of the current representation
                    ...
                    if eliminate_name != None:
                        ...
                        for piece in f_pieces:
                            if piece.name == eliminate_name:
                                ...
                                eliminated = piece
                    successor.append(Gamestate(
                        new_pieces, f_pieces, False, self.t_pieces[i], possibility, eliminated))
        else:
                    ...
                    if eliminate_name != None:
                        ...
                        for piece in t_pieces:
                            if piece.name == eliminate_name:
                                ...
                                eliminated = piece
                    successor.append(Gamestate(
                        t_pieces, new_pieces, True, self.f_pieces[i], possibility, eliminated))
        return successor
